    ...
    <>
      ...
      <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
        ...
        <p className='my-3'>
          ...
          changes that lead to a more balanced and fulfilling lifestyle. Remember that it's okay to
          seek support and guidance from professionals or mentors along the way. Your well-being and
